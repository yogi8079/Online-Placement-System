...
$query_Recordset2 = sprintf("SELECT * FROM job_master WHERE MinQualification = %s OR CompanyName=%s OR JobTitle=%s", GetSQLValueString($colname_Recordset2, "text"),GetSQLValueString($colname2_Recordset2, "text"),GetSQLValueString($colname3_Recordset2, "text"));
