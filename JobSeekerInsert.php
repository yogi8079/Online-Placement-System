...
$sql="insert into jobSeeker_reg(JobSeekerName,Address,Email,Mobile,Gender,Resume,Status,UserName,Password) VALUES (
'$Name','$Address','$Email','$Mobile','$Gender','$path1','$Status','$UserName','$Password'
